...
# Example:
id_gpa = [(doc["_id"], doc["gpa"]) for doc in students_collection.find({}, {"_id": 1, "gpa": 1})]
positions = [(doc["_id"], doc["capacity"], doc["gpa_required"]) for doc in positions_collection.find({}, {"_id": 1, "capacity": 1, "gpa_required": 1})]
promises = [(doc["student_id"], doc["promise1"], doc["promise2"], doc["promise3"]) for doc in promises_collection.find({}, {"student_id": 1, "promise1": 1, "promise2": 1, "promise3": 1})]
